...
void CSDLAppUi::ConstructL()
{
	...
	TFileName name(_L("\\resource\\apps\\cceleste.mbm"));
#endif
	...
	if(ApplicationRect().Width() == 240 && ApplicationRect().Height() == 320)
	{
	    iSdl = CSDL::NewL(gSDLClass.SdlFlags()|CSDL::EAllowImageResizeKeepRatio);
	}
	else{
